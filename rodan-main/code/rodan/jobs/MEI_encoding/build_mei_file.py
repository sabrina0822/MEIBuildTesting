...
def generate_base_document():
    ...
    #optional info that goes along with title 
    ET.SubElement(titleStmt, "title", type = "subtitle").text = "A subtitle"
    ET.SubElement(titleStmt, "title", type = "author").text = "Author"
    ...
    #Big subs of music 
    #need to figure out where group plays a role in here!
    #body: contians the whole of a single musical text, excluing any front or back matter
    #group: contains a composite musical text, grouping together a sequence of distinct musical texts 
    #Basically, can do <music> <group> <music> -- song 1 -- </music> <music> --song 2 -- </music> etc. 
    #How to make optional group thing probably a function tf if i know 
    front = SubElement(music, "front")
    body = SubElement(music, "body")
    back = SubElement(music, "back")
